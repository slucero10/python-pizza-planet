...
from .models import Ingredient, Order, OrderDetail, Size, Beverage, BeverageDetail, db
...
class OrderManager(BaseManager):
    ...
    def create(cls, order_data: dict, ingredients: List[Ingredient], beverages: List[Beverage]):
        ...
        cls.session.add_all((BeverageDetail(order_id=new_order._id, beverage_id=beverage._id)
